...
Namespace SimpleSchedulingExample
	...
	Public Class MedicalAppointment
		...
		End Function
		Friend Shared Function Create(ByVal startTime As DateTime, ByVal endTime As DateTime, ByVal doctorId As Integer, ByVal notes As String, ByVal location As String, ByVal categoryId As Integer, ByVal patientName As String, ByVal insuranceNumber As String, ByVal firstVisit As Boolean) As MedicalAppointment
